...
export BUILD=JMT-sles-11.3-intel-15.0.0-mkl-debug
...
./setup --cc=icc --cxx=icpc --python=$PYTHON --type=debug -DBUILDNAME=$BUILD -DSITE=$SITE -DBUILD_CUSTOM_BOOST=True build
