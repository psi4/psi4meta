...
export BUILD=JMT-ubuntu-10.4-gcc-4.9.2-release
...
./setup --cc=gcc --cxx=g++ --type=release --vectorization -DBUILDNAME=$BUILD -DSITE=$SITE -DBUILD_CUSTOM_BOOST=True build
