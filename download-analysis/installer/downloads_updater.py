...
p4dl = re.compile(r"""^(?P<loc>[0-9.]+) - - \[(?P<day>[0-9]*)\/(?P<month>.*)\/(?P<year>[0-9]*):(?P<hour>[0-9]*):(?P<min>[0-9]*).*\] "GET\s*./psicode-download/psi4conda-(?P<p4ver>.*)-py(?P<p4py>[23][0-9])-(?P<p4os>.*)-x86_64.sh.*$""", re.MULTILINE)
