...
./setup --fc=gfortran --cc=clang --cxx=clang++ --type=release --plugins=on --accelerate -D BUILDNAME=RDR-MacOS-10.10.4-clang3.5-accelerate-release -D SITE=merzbow --python=/usr/local/bin/python
