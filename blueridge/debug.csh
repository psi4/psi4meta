...
setenv BUILD TDC-centos-6.3-intel-15.3-mkl-debug
...
./setup --prefix=$HOME/psi4 --cc=icc --cxx=icpc --fc=ifort --boost-incdir=$HOME/boost/include --boost-libdir=$HOME/boost/lib --python=$HOME/bin/python --type=debug -D BUILDNAME=$BUILD -D SITE=$SITE build
