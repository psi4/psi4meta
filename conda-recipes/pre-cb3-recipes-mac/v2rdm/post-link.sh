...
echo "    Inputs:  ${PREFIX}/lib/python*/site-packages/v2rdm_casscf/tests" >> .messages.txt
echo "    Test (after first activating conda installation or environment):" >> .messages.txt
echo "      psi4 \"\$(dirname \$(which psi4))\"/../lib/python*/site-packages/v2rdm_casscf/tests/v2rdm1/input.dat -o output.dat" >> .messages.txt
echo "" >> .messages.txt
