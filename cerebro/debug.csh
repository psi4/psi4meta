...
setenv BUILD TDC-centos-5.9-intel-14.04-mkl-debug 
...
./setup --prefix=$HOME/psi4 --cc=icc --cxx=icpc --python=$HOME/bin/python --boost-incdir=$HOME/boost/include --boost-libdir=$HOME/boost/lib --type=debug -D BUILDNAME=$BUILD -D SITE=$SITE build
